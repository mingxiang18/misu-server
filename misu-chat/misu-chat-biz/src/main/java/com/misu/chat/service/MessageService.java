...
public interface MessageService {
    ...
    /** 按会话游标分页（beforeId 为 null 取最新一页），返回正序（旧→新）。currentUserId 用于标记 self。 */
    List<MessageDto> pageHistory(Long conversationId, Long beforeId, int size, String currentUserId);
}
