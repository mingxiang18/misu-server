...
@EnableJpaRepositories(
    basePackages = "com.misu.fileServer.repository",
    entityManagerFactoryRef = "fileServerEntityManagerFactory",
    transactionManagerRef = "fileServerTransactionManager"
)
public class FileServerDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean fileServerEntityManagerFactory(
        ...
        return builder
                .dataSource(fileServerDataSource())
                .packages("com.misu.fileServer.domain.entity")
                .persistenceUnit("fileServer")
                .build();
    }
